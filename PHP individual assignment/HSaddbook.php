    ...
    <table  class="table table-dark table-striped table-bordered container-fluid" style="max-width: fit-content;">
            <tr>
                <td>
                    ...
                    <span class = "error">* <?php echo "<br>",$titleErr;?></span>
               </td>
            </tr>
            <tr>
               <td>
                   <label>Author </label><br> 
                   <input type = "text" name = "author" value="<?php echo $author;?>"  autofocus>
                  <span class = "error">* <?php echo "<br>",$authorErr;?></span>
               </td>
            </tr>
            <tr>
               <td>
                   <label>Year Published </label><br> 
                   <input type="number" name = "year" value="<?php echo $year;?>"  autofocus>
                  <span class = "error">* <?php echo "<br>",$yearErr;?></span>
               </td>
            </tr>
            ...
            <tr>
               <td>
                   ...
                   <input type="file" name = "bCover" id = "bCover" value="<?php echo $bCover;?>"  autofocus>
                   <span class = "error">* <?php echo "<br>",$bCoverErr;?></span>
               </td>
            </tr>
            <tr>
